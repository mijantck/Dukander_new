...
public class GlobleProductListAdapter8 extends FirestoreRecyclerAdapter<GlobleProductNote8, GlobleProductListAdapter8.ViewHolde> {
    ...
    public GlobleProductListAdapter8(@NonNull FirestoreRecyclerOptions<GlobleProductNote8> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull ViewHolde holder, int position, @NonNull GlobleProductNote8 model) {
