...
public class GlobleProductListAdapter7 extends FirestoreRecyclerAdapter<GlobleProductNote7, GlobleProductListAdapter7.ViewHolde> {
    ...
    public GlobleProductListAdapter7(@NonNull FirestoreRecyclerOptions<GlobleProductNote7> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull ViewHolde holder, int position, @NonNull GlobleProductNote7 model) {
